...
case $1 in
-adduser) [ $# -ne 3 ] && usage ; useradd $2 -p $3 -m ;; -deluser) [ $# -ne 2 ] && usage ; deluser $2 --remove-all-files;; -shell) [$#-ne3]&&usage;chsh$2-s$3;;
...
-details) [ $# -ne 2 ] && usage ; finger $2 ; chage -l $2 ;; -usage) usage ;;
*) usage ;;
esac
